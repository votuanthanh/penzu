                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('journal.update', $journal) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{$journal->title}}">
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description">{{$journal->description}}</textarea>
